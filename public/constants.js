...
const TANK_CLASSES = [
    ...
    },
    {
        ...
        buffs: { bulletSpeed: 4, piercing: 2, visionRange: 2, speed: -3, maxBullets: -4 },
        special: 'scope',
        color: '#ff9f43',
    },
    {
    ...
    },
    {
        ...
        buffs: { autoTurret: 3, speed: -1, visionRange: -3, maxBullets: -3 },
        special: 'companion',
        color: '#ffd32a',
    },
    {
        ...
        buffs: { bulletSpeed: -2, bulletBounces: -1, maxBullets: -3, speed: 2, visionRange: 1 },
        special: 'laser',
        color: '#ff6b6b',
    },
    {
        ...
        buffs: { multiShot: 2, bulletSpeed: -2, bulletBounces: -1, visionRange: -1, maxBullets: 3 },
        special: 'barrage',
        color: '#a29bfe',
    },
    {
        ...
        buffs: { piercing: 1, explosive: 1, speed: -1, bulletSpeed: -1, maxBullets: -3 },
        special: 'cannon',
        color: '#e67e22',
    },
];
